...
#ifndef SingleCal_HardcodedTiming_H
#define SingleCal_HardcodedTiming_H
...
class SingleCal_HardcodedTiming : public TGRSISelector
{
public:
        TGriffin *fGrif;
        ...
        SingleCal_HardcodedTiming(TTree * /*tree*/ = 0) : TGRSISelector(), fGrif(nullptr), fGriffinBgo(NULL), fScep(nullptr), fZDS(nullptr), fLaBr(nullptr), fLaBrBgo(NULL), fTAC(nullptr), fPaces(nullptr)
        {
                SetOutputPrefix("run");
        ...
        virtual ~SingleCal_HardcodedTiming() {}
...
#ifdef SingleCal_HardcodedTiming_cxx
void SingleCal_HardcodedTiming::InitializeBranches(TTree *tree)
{
        if (!tree)
                return;
...
#endif // #ifdef SingleCal_HardcodedTiming_cxx
