...
#ifndef S1716Sept2019Selector_h
#define S1716Sept2019Selector_h
...
class S1716Sept2019Selector : public TGRSISelector
{
public:
        TGriffin *fGrif;
        ...
        S1716Sept2019Selector(TTree * /*tree*/ = 0) : TGRSISelector(), fGrif(nullptr), fGriffinBgo(NULL), fScep(nullptr), fZDS(nullptr), fLaBr(nullptr), fLaBrBgo(NULL), fTAC(nullptr), fPaces(nullptr)
        {
                SetOutputPrefix("S1716_");
        }
        virtual ~S1716Sept2019Selector() {}
        ...
        ClassDef(S1716Sept2019Selector, 1); // 2); //Makes ROOT happier
};
#endif

#ifdef S1716Sept2019Selector_cxx
void S1716Sept2019Selector::InitializeBranches(TTree *tree)
{
        if (!tree)
                return;
...
#endif // #ifdef S1716Sept2019Selector_cxx
