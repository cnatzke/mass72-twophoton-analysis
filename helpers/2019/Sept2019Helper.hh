#ifndef Sept2019Helper_h
#define Sept2019Helper_h
...
class Sept2019Helper : public TGRSIHelper,
                       public ROOT::Detail::RDF::RActionImpl<Sept2019Helper>
{
private:
...
public:
   Sept2019Helper(TList *list) : TGRSIHelper(list)
   {
      Prefix("run");
...
extern "C" Sept2019Helper *CreateHelper(TList *list) { return new Sept2019Helper(list); }
