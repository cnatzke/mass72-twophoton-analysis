#ifndef LimitCalculationHelper_h
#define LimitCalculationHelper_h
...
class LimitCalculationHelper : public TGRSIHelper,
                               public ROOT::Detail::RDF::RActionImpl<LimitCalculationHelper>
{
private:
...
public:
   LimitCalculationHelper(TList *list) : TGRSIHelper(list)
   {
      Prefix("run");
...
extern "C" LimitCalculationHelper *CreateHelper(TList *list) { return new LimitCalculationHelper(list); }
