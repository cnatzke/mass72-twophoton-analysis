#ifndef TriplePhotonCoincidenceHelperAddback_h
#define TriplePhotonCoincidenceHelperAddback_h
...
class TriplePhotonCoincidenceHelperAddback : public TGRSIHelper,
                                             public ROOT::Detail::RDF::RActionImpl<TriplePhotonCoincidenceHelperAddback>
{
private:
...
public:
   TriplePhotonCoincidenceHelperAddback(TList *list) : TGRSIHelper(list)
   {
      Prefix("run");
...
extern "C" TriplePhotonCoincidenceHelperAddback *CreateHelper(TList *list) { return new TriplePhotonCoincidenceHelperAddback(list); }
