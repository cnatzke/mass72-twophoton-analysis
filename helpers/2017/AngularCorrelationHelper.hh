...
class AngularCorrelationHelper : public TGRSIHelper,
                                 public ROOT::Detail::RDF::RActionImpl<AngularCorrelationHelper>
{
private:
...
public:
   AngularCorrelationHelper(TList *list) : TGRSIHelper(list)
   {
      ...
      // fComptonLimits0 = ReadInComptonLimitsFile(0);
      // fComptonLimits1 = ReadInComptonLimitsFile(1);
      // fAngularBinVec = ReadInComptonLimitsFile(2);

      // build Compton scatter limits
      std::string comptonLimitsDataFile = "/data_fast/cnatzke/two-photon/72Ge/data/compton_limits_110mm.csv";
      ReadInComptonLimitsFile(comptonLimitsDataFile);
      fComptonMapping = BuildComptonBands(5000);

      // std::cout << "---> RESULT TEST" << std::endl;
      // std::cout << fComptonMapping.at(2).energy.at(1500) << std::endl;
      // std::cout << fComptonMapping.at(2).angle << std::endl;
      // std::cout << fComptonMapping.at(2).comptonLimit0.at(1500) << std::endl;
      // std::cout << fComptonMapping.at(2).comptonLimit1.at(1500) << std::endl;
      // std::cout << fComptonMapping.at(2).comptonLimit2.at(1500) << std::endl;
      // std::cout << fComptonMapping.at(2).comptonLimit3.at(1500) << std::endl;
